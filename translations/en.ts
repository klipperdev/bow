...
export default {
    ...
    'export.format': 'Export to {format} format',
    ...
    'component.gallery.close-title': 'Close',
    'component.gallery.zoom-title': 'Zoom',
    'component.gallery.arrow-previous-title': 'Previous',
    'component.gallery.arrow-next-title': 'Next',
    'component.gallery.error-message': 'The image cannot be loaded',
    'component.gallery.': '',
    ...
    'views.settings-organization-user.current-password': 'Current password',
