...
module.exports = {
    ...
    themes: {
        ...
        light: {
            primary: process.env.APP_THEME_LIGHT_PRIMARY || '#4963f0',
            secondary: process.env.APP_THEME_LIGHT_SECONDARY || '#323484',
            ...
            info: process.env.APP_THEME_LIGHT_INFO || '#c5f0ff',
            success: process.env.APP_THEME_LIGHT_SUCCESS || '#3eb772',
        },
        dark: {
            primary: process.env.APP_THEME_DARK_PRIMARY || '#6c7cff',
            secondary: process.env.APP_THEME_DARK_SECONDARY || '#3a9fff',
            accent: process.env.APP_THEME_DARK_ACCENT || '#66ddca',
            error: process.env.APP_THEME_DARK_ERROR || '#ed3859',
            warning: process.env.APP_THEME_DARK_WARNING || '#fd854e',
            info: process.env.APP_THEME_DARK_INFO || '#c5f0ff',
