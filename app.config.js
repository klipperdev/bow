...
module.exports = {
    ...
    themes: {
        ...
        light: {
            ...
            accent: process.env.APP_THEME_LIGHT_ACCENT || '#223f90',
        ...
        dark: {
            primary: process.env.APP_THEME_DARK_PRIMARY || '#046dff',
            secondary: process.env.APP_THEME_DARK_SECONDARY || '#44aefb',
            accent: process.env.APP_THEME_DARK_ACCENT || '#a7beda',
